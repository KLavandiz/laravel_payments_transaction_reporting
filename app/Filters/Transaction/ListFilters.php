...
class ListFilters
{
    ...
    public array $transactionParams = array(
        'fromDate' => array(0 => 'created_at', 1 => '>'),
        'toDate' => array(0 => 'created_at', 1 => '<'),
        'status' => array(0 => 'status', 1 => '='),
        'operation' => array(0 => 'operation', 1 => '='),
        'merchantId' => array(0 => 'merchant_id', 1 => '='),
        'acquirerId' => array(0 => 'acquirer_transaction_id', 1 => '=')
    ,'errorCode' => array(0 => 'message', 1 => '=')
    );

    public array $acquirersParams = array('paymentMethod' => array(0=>'type',1=>'='));
